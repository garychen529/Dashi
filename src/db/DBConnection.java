...
/*
 * For use with DB
 * OOD - Because we have two databases (MySQL and MongoDB)
 * Interface is very lean: 定统一的函数头, 不管具体实现, 写一个对所有DB模式都管用
 * 
 */
...
public interface DBConnection {
	 ...
	 * @return
	 * 
	 * 		Boolean capitalized because it can return more info (can return
	 *         object, not just true or false)
	 */
