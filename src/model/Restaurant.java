...
public class Restaurant {
	...
	// this constructor is used to set the order the data is returned
	...
	/*
	 * To communicate with front-end (because front-end only knows JSON objects)
	 */
	...
	/*
	 * Turn [a, b, c] to "a, b, c" Make it easier to save on the db
	 * 
	 */
	...
	/*
	 * Turn string to array Turns string stored back to JSONArray (for front-end
	 * display)
	 * 
	 */
